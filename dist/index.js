#!/usr/bin/env node
import validate$1 from '@adobe/reactor-validator';
import chalk from 'chalk';
import path, { resolve, dirname, normalize, join, relative, extname, basename } from 'path';
import fs, { readFileSync, statSync, readdirSync, writeFile } from 'fs';
import { fileURLToPath } from 'url';
import { strictEqual, notStrictEqual } from 'assert';
import { format, inspect } from 'util';
import { createRequire } from 'node:module';
import { readdirSync as readdirSync$1, readFileSync as readFileSync$1 } from 'node:fs';
...
const argv = Yargs(hideBin(process$1.argv))
